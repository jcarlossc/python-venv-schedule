# PROJETO PYTHON - VENV/SCHEDULE - Executa uma função a cada minuto.
...
ambiente virtual VENV e implementa um pequeno algoritmo que executa uma função a cada minuto, com o módulo SCHEDULE.
